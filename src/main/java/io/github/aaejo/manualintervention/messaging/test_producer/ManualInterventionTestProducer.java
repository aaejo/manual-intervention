package io.github.aaejo.manualintervention.messaging.test_producer;
...
@Slf4j
@Component
public class ManualInterventionTestProducer {

    private static final String TOPIC = "manual-intervention";

    private final KafkaTemplate<String, IncompleteScrape> template;

    public ManualInterventionTestProducer(KafkaTemplate<String, IncompleteScrape> template) {
